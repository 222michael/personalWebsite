      ...
      <div className="terminal-window">
        ...
        <div className="terminal-content">
          <div className="hero-section">
            ...
            <p className="bio">
              Full-stack developer with expertise in building modern web and mobile
              applications. Currently interning at NexLogic Telecommunications,
              working on AI-powered chatbots and Flutter mobile apps. Passionate
          ...
          <div id="about" className={`content-section ${activeSection === 'about' ? 'typing-animation' : ''}`}>
            ...
            <div className="section-content">
              <p>
                Full-stack developer with expertise in building modern web and mobile
                applications. Currently interning at NexLogic Telecommunications, working
                on AI-powered chatbots and Flutter mobile apps. Passionate about creating
          ...
          <div id="contact" className={`content-section ${activeSection === 'contact' ? 'typing-animation' : ''}`}>
            ...
            <div className="section-content">
              ...
              <div className="current-position">
                ...
                <div className="position-title">Junior Software Developer Intern</div>
                <div className="position-company">NexLogic Telecommunications - Silang, Cavite</div>
                <div className="position-date">Feb 2025 - Apr 2025</div>
              </div>
